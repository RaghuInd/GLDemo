...
public class Driver {
	...
	public static void main(String[] args) {
		...
		Supplier<Employee> employeeSupplier = () -> new Employee(1, "Name 1", 10000.0);
		System.out.println(employeeSupplier.get());

		// Consumer
		// ctrl +

		Consumer<String> displayName = (name) -> System.out.println(name);
		...
		System.out.println("emp after sal hike :" + hikeEmployeeSalary.apply(emp,5.5));
